...
<template>
  <div class="details-grid">
    <div class="details-info card card-content">
    ...
    <div class="details-map card card-content">
      <h3>Delimitação do Local (Preview)</h3>
      <GeneralMap :coordinates="details.mapCoordinates" />
    </div>
  </div>
</template>
